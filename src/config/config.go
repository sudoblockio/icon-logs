...
type configType struct {
	...
	// Topics
	ConsumerGroupHead            string            `envconfig:"CONSUMER_GROUP_HEAD" required:"false" default:"logs-consumer-group-head"`
	ConsumerGroupTail            string            `envconfig:"CONSUMER_GROUP_TAIL" required:"false" default:"logs-consumer-group-tail"`
